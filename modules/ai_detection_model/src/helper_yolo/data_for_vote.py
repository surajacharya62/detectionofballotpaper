...
class CreateDataForVote():
    ...
    def data(self, yolo_files, test_files, image_name, is_single_image):
        ...
        test_set = ElectoralSymbolDataset(test_files, image_name, test_set_path, label_id, self.get_transform(True), is_single_image)
        ...
        obj_val.predicted_images(test_set, pred_df, label_id)

        obj_com = CompareBoundingBox()
        obj_com.labels(test_set, pred_df, label_id)
