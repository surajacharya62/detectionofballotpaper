...
# ##--------------------------------------------Testing the model
test_path = '../../../testing_set/set4/test/image_0009.jpg'
test_set = UnlabeledTestDataset(test_path, get_transform(True))
test_loader = DataLoader(test_set, batch_size=1, shuffle=False)

torch.cuda.empty_cache()
model = get_object_detection_model(num_classes)
model.load_state_dict(torch.load('../../../trained_models/trained_model_fasterrcnn_2.pth', map_location= torch.device('cpu')))
model.eval()
predictions = []
for images in test_loader:  # No labels if your test set is unlabeled
    image = images # Move images to the device where your model is
...
# true_labels_path = '../../../testing_set/set4/test'
# obj = Metrics()
